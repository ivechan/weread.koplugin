...
local zh = {
    ...
    ["%1/%2 pages"] = "%1/%2页",
    ["Bookshelf view"] = "书架视图",
    ["Open bookshelf on start"] = "启动时打开书架",
    ["List view"] = "列表模式",
    ["Cover view"] = "封面模式",
    ...
    ["⌖ Locate"] = "⌖ 定位",
    ["Locate chapter"] = "定位章节",
    ["Jump to current chapter"] = "跳转到当前章节",
    ["Go to chapter number"] = "跳转到指定章节",
    ["Search chapter title"] = "搜索章节标题",
    ["Go to chapter (1-%1)"] = "跳转到章节（1-%1）",
    ["Go"] = "跳转",
    ["No matching chapters."] = "没有匹配的章节。",
    ...
    ["Continue to next chapter automatically"] = "自动衔接下一章",
    ["Continue to previous chapter automatically"] = "自动衔接上一章",
    ["Could not open the next chapter: %1"] = "无法打开下一章：%1",
